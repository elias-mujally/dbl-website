      ...
      <main>
            <section className="product-page-hero section-grid reveal in-view">
              ...
              <div className="section-copy">
                ...
                <div className="button-row"><a className="btn btn-primary" href="https://dblab.gumroad.com/l/oigexi" target="_blank" rel="noopener" data-i18n="promptVaultPage.cta">Get Instant Access</a><a className="btn btn-secondary" href="/payment-methods.html" data-i18n="promptVaultPage.alternativePayment">Alternative Payment Methods</a><button type="button" className="btn btn-secondary discount-code-toggle" data-discount-reveal="" data-target="#prompt-vault-discount" data-i18n="promptVaultPage.discountCodeButton">Get Discount Code</button></div>
                <div id="prompt-vault-discount" className="discount-code-box"><p data-i18n="promptVaultPage.discountCodeIntro">Use this code on Gumroad checkout:</p><code>dblab25</code><span className="discount-code-note" data-i18n="promptVaultPage.discountCodeNote">25% discount. Valid for the first 10 customers only.</span><span className="discount-code-note" data-i18n="promptVaultPage.discountCodePlatform">Note: the code is activated on Gumroad, not inside the website.</span></div>
              </div>
            </section>
